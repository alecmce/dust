...
import dust.inspector.control.InspectorPopulatorTest;
import dust.inspector.data.InspectorIteratorTest;
import dust.inspector.data.InspectorTest;
import dust.inspector.systems.InspectorListenersTest;
import dust.inspector.systems.UpdateInspectorViewSystemTest;
...
import dust.math.pure.ModIntTest;
...
{		
	...
	public function new()
	{
		...
		add(dust.inspector.control.InspectorPopulatorTest);
		add(dust.inspector.data.InspectorIteratorTest);
		add(dust.inspector.data.InspectorTest);
		add(dust.inspector.systems.InspectorListenersTest);
		add(dust.inspector.systems.UpdateInspectorViewSystemTest);
