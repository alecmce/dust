...
import dust.collections.CollectionConfigTest;
import dust.collections.CollectionConnectorTest;
import dust.collections.CollectionMapTest;
import dust.collections.CollectionTest;
...
{		
	...
	public function new()
	{
		...
		add(dust.collections.CollectionConfigTest);
		add(dust.collections.CollectionConnectorTest);
		add(dust.collections.CollectionMapTest);
		add(dust.collections.CollectionTest);
