...
import dust.graphics.control.PrioritizedPaintersSystemTest;
import dust.graphics.data.PaintTest;
...
{		
	...
	public function new()
	{
		...
		add(dust.graphics.control.PrioritizedPaintersSystemTest);
		add(dust.graphics.data.PaintTest);
